        ...
        <section className="full-detail-description full-detail">
				<div className="container">
                  ...
                  <li>امتحانات المستوى محوسبة ويتم تقديمها داخل مختبرات الحاسوب في الكلية.</li>
							...
							<div className="row-bottom">
								<h2 className="detail-title" style={{fontSize:"18px !important"}}>مكونات امتحان تحديد المستوى</h2>
								<table className="table table-striped">
                  <tbody>
                    <tr>
                      <td><b>المهارة</b></td>
                      <td><b>عدد الاسئلة</b></td>
                      <td><b>العلامة القصوى</b></td>
                      <td><b>المدة</b></td>
                    </tr>
                  </tbody>
                  <tbody>
              ...
              <div className="row-bottom">
								<h2 className="detail-title" style={{fontSize:"18px !important"}}>توزيع المستويات حسب العلامات</h2>
								<table className="table table-striped">
                  <tbody>
                    <tr>
