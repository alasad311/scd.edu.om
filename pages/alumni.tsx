...
export async function getServerSideProps() {
  ...
  const respresident = await fetch('https://scd.edu.om/api/alumni-president')
  const president = await respresident.json()
  const restestimonial = await fetch('https://scd.edu.om/api/alumni-testimonial')
  const testimonial = await restestimonial.json()
  const reslatestevent = await fetch('https://scd.edu.om/api/alumni-latest-event')
  const latestevent = await reslatestevent.json()
  const ressupcomingevent = await fetch('https://scd.edu.om/api/alumni-upcoming-event')
